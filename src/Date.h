...
class Date {
  public:
    ...
    int get_year(int t);
    int get_month() {
      return this->get_month(0);
      }
    int get_month(int t);
    string get_month_string() {
      return this->get_month_string(0);
      }
    string get_month_string(int t);
    int get_day_of_month() {
      return this->get_day_of_month(0);
      }
    int get_day_of_month(int t);
    int get_day_of_year() {
      return this->get_day_of_year(0);
      }
    ...
    int get_days_since_jan_1_1600() {
      return this->days_since_jan_1_1600;
      }
    void advance() {
      this->days_since_jan_1_1600++;
      }
    void advance(int days) {
      this->days_since_jan_1_1600+=days;
      }
    Date * clone();
