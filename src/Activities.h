...
class Activities {
  public:
    ...
    UNIT_TEST_VIRTUAL Place * get_household() {
      return favorite_place[HOUSEHOLD_INDEX];
      }
    UNIT_TEST_VIRTUAL Place * get_neighborhood() {
      return favorite_place[NEIGHBORHOOD_INDEX];
      }
    UNIT_TEST_VIRTUAL Place * get_school() {
      return favorite_place[SCHOOL_INDEX];
      }
    UNIT_TEST_VIRTUAL Place * get_classroom() {
      return favorite_place[CLASSROOM_INDEX];
      }
    UNIT_TEST_VIRTUAL Place * get_workplace() {
      return favorite_place[WORKPLACE_INDEX];
      }
    UNIT_TEST_VIRTUAL Place * get_office() {
      return favorite_place[OFFICE_INDEX];
      }
    void assign_school();
