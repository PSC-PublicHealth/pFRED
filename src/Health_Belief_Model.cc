...
void Health_Belief_Model::get_parameters() {
  ...
  if (n != 2) {
    printf("bad HBM_susceptibility_threshold\n");
    abort();
    }
  ...
  if (n != 2) {
    printf("bad HBM_severity_threshold\n");
    abort();
    }
  ...
  if (n != 2) {
    printf("bad HBM_benefits_threshold\n");
    abort();
    }
  ...
  if (n != 2) {
    printf("bad HBM_barriers_threshold\n");
    abort();
    }
