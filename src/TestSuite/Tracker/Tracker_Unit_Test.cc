...
int main(void){
  ...
  dayTrack.set_index_key_pair(22,"Int Key",999);
  ...
  dayTrack.add_for_all_indices("Int Key","New Key 4");

  printf("%s",dayTrack.print_key_index_list("Int Key").c_str());
  ...
  //vector < string > intKeys = dk._get_keys("int");
