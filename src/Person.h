...
class Person {
  public:
    ...
    double get_real_age(int day) const {
      return demographics->get_real_age(day);
      }
    ...
    UNIT_TEST_VIRTUAL char get_disease_status(int disease) const {
      return health->get_disease_status(disease);
      }
    UNIT_TEST_VIRTUAL double get_susceptibility(int disease) const {
      return health->get_susceptibility(disease);
      }
    UNIT_TEST_VIRTUAL double get_infectivity(int disease, int day) const {
    ...
    void update_demographics(Date *sim_start_date, int day) {
      demographics->update(sim_start_date, day);
      }
    ...
    void update_activities(int day) {
    ...
    // access functions:
    UNIT_TEST_VIRTUAL int get_id() const {
      return idx;
      }
    UNIT_TEST_VIRTUAL Population* get_population() const {
      return pop;
      }
    UNIT_TEST_VIRTUAL Demographics* get_demographics() const {
      return demographics;
      }
    UNIT_TEST_VIRTUAL Health *get_health() const {
      return health;
      }
    UNIT_TEST_VIRTUAL Activities* get_activities() const {
      return activities;
      }
    UNIT_TEST_VIRTUAL Behavior* get_behavior() const {
      return behavior;
      }
