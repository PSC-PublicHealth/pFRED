...
class Population : public Person_Event_Interface {
  public:
    ...
    UNIT_TEST_VIRTUAL int get_diseases() {
      return diseases;
      }
    UNIT_TEST_VIRTUAL int get_pop_size() {
      return pop_size;
      }

    //Mitigation Managers
    UNIT_TEST_VIRTUAL AV_Manager *get_av_manager() {
      return av_manager;
      }
    UNIT_TEST_VIRTUAL Vaccine_Manager *get_vaccine_manager() {
      return vacc_manager;
      }
