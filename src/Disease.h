...
class Disease {
  public:
    ...
    UNIT_TEST_VIRTUAL double get_mortality_rate() {
      return mortality_rate;
      }
    UNIT_TEST_VIRTUAL int get_id() {
      return id;
      }
    UNIT_TEST_VIRTUAL double get_transmissibility() {
      return transmissibility;
      }
    UNIT_TEST_VIRTUAL double get_transmissibility(int strain);
    UNIT_TEST_VIRTUAL double get_attack_rate();
    UNIT_TEST_VIRTUAL Age_Map* get_residual_immunity() const {
      return residual_immunity;
      }
    UNIT_TEST_VIRTUAL Age_Map* get_at_risk() const {
      return at_risk;
      }
    ...
    UNIT_TEST_VIRTUAL Epidemic * get_epidemic() {
      return epidemic;
      }
    ...
    void increment_S_count() {
      epidemic->increment_S_count();
      }
    void decrement_S_count() {
      epidemic->decrement_S_count();
      }
    void increment_E_count() {
      epidemic->increment_E_count();
      }
    void decrement_E_count() {
      epidemic->decrement_E_count();
      }
    void increment_I_count() {
      epidemic->increment_I_count();
      }
    void decrement_I_count() {
      epidemic->decrement_I_count();
      }
    void increment_i_count() {
      epidemic->increment_i_count();
      }
    ...
    void increment_R_count() {
      epidemic->increment_R_count();
      }
    void decrement_R_count() {
      epidemic->decrement_R_count();
      }
    void increment_r_count() {
      epidemic->increment_r_count();
      }
    ...
    void increment_C_count() {
      epidemic->increment_C_count();
      }
    void decrement_C_count() {
      epidemic->decrement_C_count();
      }
    void increment_c_count() {
      epidemic->increment_c_count();
      }
    ...
    void increment_M_count() {
      epidemic->increment_M_count();
      }
    void decrement_M_count() {
      epidemic->decrement_M_count();
      }
