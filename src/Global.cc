...
void Global::get_global_parameters() {
  ...
  Params::get_param((char *) "behavior_model", Global::Behavior_model_type);
  Params:: get_param((char *) "diseases", &Global::Diseases);
  Params::get_param((char *) "prob_accept_vaccine", &Global::Prob_accept_vaccine);
  Params:: get_param((char *) "prob_accept_another_vaccine_dose", &Global::Prob_accept_vaccine_dose);
