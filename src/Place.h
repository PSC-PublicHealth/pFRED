...
class Place {
  ...
  public:
    ...
    bool is_infectious(int disease) {
      return I[disease] > 0;
      }
    ...
    UNIT_TEST_VIRTUAL char * get_label() {
      return label;
      }
    UNIT_TEST_VIRTUAL int get_type() {
      return type;
      }
    UNIT_TEST_VIRTUAL double get_latitude() {
      return latitude;
      }
    UNIT_TEST_VIRTUAL double get_longitude() {
      return longitude;
      }
    UNIT_TEST_VIRTUAL int get_S(int disease) {
      return S[disease];
      }
    UNIT_TEST_VIRTUAL int get_I(int disease) {
      return (int) (infectious[disease].size());
      }
    UNIT_TEST_VIRTUAL int get_symptomatic(int disease) {
      return Sympt[disease];
      }
    UNIT_TEST_VIRTUAL int get_size() {
      return N;
      }
    UNIT_TEST_VIRTUAL int get_close_date() {
      return close_date;
      }
    UNIT_TEST_VIRTUAL int get_open_date() {
      return open_date;
      }
    UNIT_TEST_VIRTUAL Population *get_population() {
      return population;
      }
    UNIT_TEST_VIRTUAL int get_daily_cases(int disease) {
      return cases[disease];
      }
    UNIT_TEST_VIRTUAL int get_daily_deaths(int disease) {
      return deaths[disease];
      }
    UNIT_TEST_VIRTUAL int get_total_cases(int disease) {
      return total_cases[disease];
      }
    UNIT_TEST_VIRTUAL int get_total_deaths(int disease) {
      return total_deaths[disease];
      }
    UNIT_TEST_VIRTUAL double get_incidence_rate(int disease) {
      return (double) total_cases[disease] / (double) N;
      }

    UNIT_TEST_VIRTUAL void set_id(int n) {
      id = n;
      }
    UNIT_TEST_VIRTUAL void set_type(char t) {
      type = t;
      }
    UNIT_TEST_VIRTUAL void set_latitude(double x) {
      latitude = x;
      }
    UNIT_TEST_VIRTUAL void set_longitude(double x) {
      longitude = x;
      }
    UNIT_TEST_VIRTUAL void set_close_date(int day) {
      close_date = day;
      }
    UNIT_TEST_VIRTUAL void set_open_date(int day) {
      open_date = day;
      }
    UNIT_TEST_VIRTUAL void set_population(Population *p) {
      population = p;
      }
    UNIT_TEST_VIRTUAL void set_container(Place *cont) {
      container = cont;
      }
    UNIT_TEST_VIRTUAL void add_case() {
      cases++;
      }
    UNIT_TEST_VIRTUAL void add_deaths() {
      deaths++;
      }
    Patch * get_patch() {
      return patch;
