...
class Transmission {
 public:
  ...
  // general
  UNIT_TEST_VIRTUAL Person *getInfector() const { return infector; }
  UNIT_TEST_VIRTUAL Place *getInfectedPlace() const { return place; }
  UNIT_TEST_VIRTUAL void setInitialLoads(std::map<int, double> *initialLoads) { this->initialLoads = initialLoads; }
  UNIT_TEST_VIRTUAL std::map<int, double> * getInitialLoads() { return initialLoads; }
